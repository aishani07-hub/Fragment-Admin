...
export const getFAQs = async () => {
    try {
        const response = await fetch(endpoints.faqs());
        if (!response.ok) {
...
export const answerQuestion = async (id, answerText) => {
    try {
        const response = await fetch(endpoints.faqById(id), {
            method: 'PUT',
            headers: { 'Content-Type': 'application/json' },
...
export const deleteQuestion = async (id) => {
    try {
        await fetch(endpoints.faqById(id), {
            method: 'DELETE'
        });
    } catch (error) {
...
export const saveFAQReaction = async (id, newReaction, oldReaction) => {
    try {
        ...
        if (oldReaction) {
            await fetch(endpoints.faqReaction(id), {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json' },
        ...
        if (newReaction) {
            const response = await fetch(endpoints.faqReaction(id), {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json' },
